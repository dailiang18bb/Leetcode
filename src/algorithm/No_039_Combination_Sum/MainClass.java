package algorithm.No_039_Combination_Sum;
...
class Solution {
    ...
    private void helper(int[] candidates, int target, List<Integer> path, int currSum, int start, List<List<Integer>> res){
        if(currSum == target){
            ...
            for(int i = start; i < candidates.length; i++){
                ...
                helper(candidates, target, path, currSum, i, res);
                currSum -= candidates[i];
